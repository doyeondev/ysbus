...
export default function Footer() {
  return (
    <>
      <footer className="body-font text-xs">
        <div className="mx-auto flex flex-col items-center px-10 py-6 sm:flex-row">
          ...
          <div className="flex items-center space-x-3">
            ...
            <p className="mt-4  text-gray-500 sm:mt-0">이메일: info@clib.io</p>
          </div>
